...
KG_CONTEXT: Dict[str, Any] = {
    ...
    "upstream_paths": [
        {
            "path_id": "PATH_001",
            "nodes": ["U2-CND-EXPANSION-JOINT-EXHAUST", "U2-CND-HOTWELL"],
            "edges": [{"from_node": "U2-CND-EXPANSION-JOINT-EXHAUST", "to_node": "U2-CND-HOTWELL", "edge_type": "UPSTREAM_OF"}],
            "path_strength": 0.90,
        },
        {
            "path_id": "PATH_002",
            "nodes": ["U2-CND-TUBE-BUNDLE-A", "U2-CND-HOTWELL"],
            "edges": [{"from_node": "U2-CND-TUBE-BUNDLE-A", "to_node": "U2-CND-HOTWELL", "edge_type": "UPSTREAM_OF"}],
            "path_strength": 0.85,
        },
        {
            "path_id": "PATH_003",
            "nodes": ["U2-CND-TUBE-BUNDLE-B", "U2-CND-HOTWELL"],
            "edges": [{"from_node": "U2-CND-TUBE-BUNDLE-B", "to_node": "U2-CND-HOTWELL", "edge_type": "UPSTREAM_OF"}],
            "path_strength": 0.85,
        },
        ...
        {
            "path_id": "PATH_004",
            "nodes": ["U2-HVAC-TURBINE-BAY-FAN-A", "U2-CND-EXPANSION-JOINT-EXHAUST"],
            "edges": [{"from_node": "U2-HVAC-TURBINE-BAY-FAN-A", "to_node": "U2-CND-EXPANSION-JOINT-EXHAUST", "edge_type": "CONNECTED_TO"}],
            "path_strength": 0.60,
        },
        {
            "path_id": "PATH_005",
            "nodes": ["U2-AIR-EJECTOR-A", "U2-CND-EXPANSION-JOINT-EXHAUST"],
            "edges": [{"from_node": "U2-AIR-EJECTOR-A", "to_node": "U2-CND-EXPANSION-JOINT-EXHAUST", "edge_type": "UPSTREAM_OF"}],
            "path_strength": 0.75,
        },
    ],
