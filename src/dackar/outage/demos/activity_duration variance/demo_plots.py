"""
demo_plots.py — Reusable plot functions for outage uncertainty show-and-tell.
...
def plot_activity_risk_ranking(
    ...
    *,
    ...
    def _barh(ax, vals, xlabel, subtitle):
        bars = ax.barh(ranked, vals, color=palette)
...
def plot_analog_scatter(
    ...
    *,
    ...
    """Planned vs P50 estimated duration, coloured by overrun fraction.
...
def plot_duration_summary_bars(
    ...
    *,
    ...
    bars = ax.barh(y - h / 2, p50_vals, h, color=colors, alpha=0.85,
